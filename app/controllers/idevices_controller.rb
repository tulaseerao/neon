class IdevicesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @idevice.update(idevice_params)
        format.html { redirect_to @idevice, notice: 'Device was successfully updated.' }
  ...
  private
    ...
    def idevice_params
      params.require(:idevice).permit(:name, :device_type, :model_number, :hd_capacity, :serial_number, :asset_tag)
    end
end
