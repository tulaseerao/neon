...
class TimelinesControllerTest < ActionController::TestCase
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post :create, timeline: { date_of_service: @timeline.date_of_service, device: @timeline.device, qty: @timeline.qty }
    end
  ...
  test "should update timeline" do
    patch :update, id: @timeline, timeline: { date_of_service: @timeline.date_of_service, device: @timeline.device, qty: @timeline.qty }
    assert_redirected_to timeline_path(assigns(:timeline))
  end
